...
class CustomFormattingTest(TestCase):
    ...
    def test_split_rows_vertical(self):
        ...
        self.assertEqual(
            [["A", "C"], ["B", ""]], split_rows_vertically(["A", "B", "C"], 2)
        )
        self.assertEqual(
            [["A", "C"], ["B", "D"]], split_rows_vertically(["A", "B", "C", "D"], 2)
        )
        self.assertEqual(
            [["A"], ["B"], ["C"], ["D"]], split_rows_vertically(["A", "B", "C", "D"], 1)
        )
        self.assertEqual(
            [["A", "C", ""], ["B", "D", ""]],
            split_rows_vertically(["A", "B", "C", "D"], 3),
        )
        self.assertEqual(
            [["A", "B", "C", "D"]], split_rows_vertically(["A", "B", "C", "D"], 4)
        )
        self.assertEqual(
            [["A", "B", "C", "D"]], split_rows_vertically(["A", "B", "C", "D"], 4)
        )
        self.assertEqual(
            [["A", "C", "E"], ["B", "D", ""]],
            split_rows_vertically(["A", "B", "C", "D", "E"], 3),
        )
    ...
    def test_split_rows_horizontally(self):
        ...
        self.assertEqual(
            [["A", "B"], ["C", ""]], split_rows_horizontally(["A", "B", "C"], 2)
        )
        self.assertEqual(
            [["A", "B"], ["C", "D"]], split_rows_horizontally(["A", "B", "C", "D"], 2)
        )
        self.assertEqual(
            [["A"], ["B"], ["C"], ["D"]],
            split_rows_horizontally(["A", "B", "C", "D"], 1),
        )
        self.assertEqual(
            [["A", "B", "C"], ["D", "", ""]],
            split_rows_horizontally(["A", "B", "C", "D"], 3),
        )
        self.assertEqual(
            [["A", "B", "C", "D"]], split_rows_horizontally(["A", "B", "C", "D"], 4)
        )
