...
{{instance.code|trim}}
    ...
    & \multicolumn{5}{l}{\parbox[t]{11cm}{ {{instance.full_description|tex_escape|trim}} }} \\
\tabularnewline
{% for lineitem in instance.lineitems.all %} \multicolumn{2}{l}{ {{lineitem.name|tex_escape}} } & {{lineitem.unit_qty|ubrdecimal}} & {{lineitem.unit|tex_escape}} & {{lineitem.price|money}} & {{lineitem.price_per_task_unit|money }} \\{% endfor %} \tabucline{1-6} 
    & & {{'1,00'|bold}} & {{task.unit|tex_escape|trim|bold}} & & {{instance.unit_price|money|tex_escape|trim|bold}} \\
