    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(unique=True, max_length=254, null=True, verbose_name='email address', blank=True)),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now, verbose_name='date joined')),
                ('language', models.CharField(max_length=2, choices=[('de', 'Deutsch'), ('en', 'English')], blank=True, verbose_name='language')),
