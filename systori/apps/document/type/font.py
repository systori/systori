...
font_families = ["OpenSans", "DroidSerif", "Tinos", "Ubuntu"]
...
for font_name in font_families:
    ...
    fonts[font_name].add(
        ParagraphStyle(
            name="SmallRight", parent=fonts[font_name]["Small"], alignment=TA_RIGHT
        )
    )
    fonts[font_name].add(
        ParagraphStyle(
    ...
    fonts[font_name].add(
        ParagraphStyle(
            name="NormalRight", parent=fonts[font_name]["Normal"], alignment=TA_RIGHT
        )
    )
    fonts[font_name].add(
        ParagraphStyle(
            name="Bold", fontName="{}-Bold".format(font_name), fontSize=10, leading=12
        )
    )
    fonts[font_name].add(
        ParagraphStyle(
            name="BoldRight", parent=fonts[font_name]["Bold"], alignment=TA_RIGHT
        )
    )
    fonts[font_name].add(
        ParagraphStyle(
            name="BodyText", parent=fonts[font_name]["Normal"], spaceBefore=6
        )
    )
    fonts[font_name].add(
        ParagraphStyle(
