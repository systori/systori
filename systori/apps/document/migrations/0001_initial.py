    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_pdf', models.FileField(upload_to=None)),#systori.apps.document.models.generate_file_path)),
                ('email_latex', models.FileField(upload_to=None)),#systori.apps.document.models.generate_file_path)),
                ('print_pdf', models.FileField(upload_to=None)),#systori.apps.document.models.generate_file_path)),
                ('print_latex', models.FileField(upload_to=None)),#systori.apps.document.models.generate_file_path)),
                ('json', models.FileField(upload_to=None)),#systori.apps.document.models.generate_file_path)),
