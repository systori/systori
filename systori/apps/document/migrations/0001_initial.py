    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_pdf', models.FileField(upload_to=systori.apps.document.models.generate_file_path)),
                ('email_latex', models.FileField(upload_to=systori.apps.document.models.generate_file_path)),
