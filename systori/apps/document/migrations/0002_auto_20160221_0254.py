    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="project.Project", related_name="refunds", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="refund",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                verbose_name="Jobs", to="task.Job", related_name="proposals"
            ),
        ),
        migrations.AddField(
            model_name="proposal",
        ...
        migrations.AddField(
            ...
            name="project",
            field=models.ForeignKey(
                to="project.Project", related_name="proposals", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="invoice",
        ...
        migrations.AddField(
            ...
            name="project",
            field=models.ForeignKey(
                to="project.Project", related_name="invoices", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="invoice",
