...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='invoice',
            name='letterhead',
            field=models.ForeignKey(related_name='invoice_documents', default=None, to='document.Letterhead'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='proposal',
            name='letterhead',
            field=models.ForeignKey(related_name='proposal_documents', default=None, to='document.Letterhead'),
            preserve_default=False,
        ),
    ]
