...
class Migration(migrations.Migration):
    ...
    dependencies = [("company", "0001_initial"), ("equipment", "0001_initial")]
            ...
            migrations.CreateModel(
                ...
                fields=[
                    ...
                    (
                        "start",
                        models.TimeField(
                            default=datetime.time(7, 0), verbose_name="Start"
                        ),
                    ),
                    (
                        "end",
                        models.TimeField(
                            default=datetime.time(16, 0), verbose_name="End"
                        ),
                    ),
        ...
        RunInTemplate(
            migrations.CreateModel(
                ...
                fields=[
                    ...
                    (
                        "name",
                        models.CharField(max_length=512, verbose_name="Site Name"),
                    ),
                    (
                        "address",
        ...
        RunInTemplate(
            migrations.CreateModel(
                ...
                fields=[
                    ...
                    (
                        "name",
                        models.CharField(max_length=512, verbose_name="Project Name"),
                    ),
                    (
                        "description",
                        models.TextField(
                    ...
                    (
                        "structure",
                        systori.apps.task.gaeb.structure.GAEBStructureField(
                            default="01.01.001", verbose_name="Numbering Structure"
                        ),
                    ),
                    (
                        "phase",
