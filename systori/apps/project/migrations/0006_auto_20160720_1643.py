...
class Migration(migrations.Migration):
    ...
    dependencies = [("project", "0005_jobsite_travel_time")]

    operations = [
        migrations.AddField(
            model_name="project",
            name="structure",
            field=GAEBStructureField(
        ...
        migrations.RemoveField(model_name="project", name="job_zfill"),
        migrations.RemoveField(model_name="project", name="taskgroup_zfill"),
        migrations.RemoveField(model_name="project", name="task_zfill"),
        migrations.AlterModelOptions(
            name="teammember",
            options={"ordering": ["-is_foreman", "worker__user__first_name"]},
        ),
        migrations.RenameField(
            model_name="dailyplan", old_name="accesses", new_name="workers"
        ),
        migrations.RenameField(
            model_name="teammember", old_name="access", new_name="worker"
        ),
