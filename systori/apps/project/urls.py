...
urlpatterns = [
    ...
    url(r'^import-project$', office_auth(GAEBImportView.as_view()), name='project.import'),
    url(r'^project-(?P<project_pk>\d+)/import-job$', office_auth(GAEBImportView.as_view()), name='job.import'),
