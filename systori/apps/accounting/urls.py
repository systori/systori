...
urlpatterns = patterns('',
                       ...
                       url(r'^create-bank-account$', office_auth(BankAccountCreate.as_view()),
                           name='bank.account.create'),
                       url(r'^bank-account-(?P<pk>\d+)/edit$', office_auth(BankAccountUpdate.as_view()),
                           name='bank.account.edit'),
                       url(r'^bank-account-(?P<pk>\d+)/delete$', office_auth(BankAccountDelete.as_view()),
