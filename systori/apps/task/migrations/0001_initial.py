    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "job_code",
                    models.PositiveSmallIntegerField(default=0, verbose_name="Code"),
                ),
                (
                    "description",
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=0, verbose_name="Task Group Offset"
                    ),
                ),
                (
                    "billing_method",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="task.TaskGroup", related_name="tasks", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            ...
            name="task",
            field=models.ForeignKey(
                to="task.Task", related_name="progressreports", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
