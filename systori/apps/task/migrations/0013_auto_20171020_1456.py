...
def add_missing_job_accounts(apps, schema_editor):
    ...
    for job in Job.objects.filter(account_id__isnull=True).filter(project__is_template=False):
        code = 10000 + job.id
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('task', '0012_auto_20170613_1704'),
    ]

    operations = [
        RunInSchemas(migrations.RunPython(add_missing_job_accounts)),
    ]
