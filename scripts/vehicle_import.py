...
contractors = {67: "Günster & Leibfahrt", 66: "Auto Ihm GmbH & Co.KG"}
...
for entry in data:
    if "vehicle.vehicle" in entry["model"]:
        ...
        unaware = datetime.strptime(
            "{} {}".format(entry["fields"]["date"], entry["fields"]["time"]),
            "%Y-%m-%d %X",
        )
        ...
        contractor = [
            contractors[entry["fields"]["contractor"]]
            if entry["fields"]["contractor"] is not None
            else ""
        ][0]
