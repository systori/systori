...
level_task = TaskFactory(name="Level Area", group=booth_group, qty=1, total=1, description=desc)
...
concrete_task = TaskFactory(name="Pour Concrete Pad", group=booth_group, qty=1, total=1, description=desc)
