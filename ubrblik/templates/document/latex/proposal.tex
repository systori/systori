...
{{instance.code}}
    ...
    & & {{task.qty|floatformat:3}} & {{task.unit}} & {{instance.unit_price|floatformat:2}} €  & {% if task.is_optional or not instance.selected %}{% trans 'Optional' %}{% else %}{{instance.fixed_price_estimate|floatformat:2}} €{% endif %} \\
{% endfor %}
{% endfor %}
