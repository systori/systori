...
{% if contact.business %}{{ contact.business|tex_escape }} \\{% endif %}
...
{% if job.taskgroups.all|length > 1 %}
& \multicolumn{4}{r}{\parbox[b]{8.5cm}{ \textbf{ {% trans 'Total' %} {{taskgroup.code}} - {{taskgroup.name}} }} } & \textbf{ {{taskgroup.estimate_total|money}}  }\\
\\
{% endif %}
{% endfor %}
...
{% for job in jobs.all %}
{% for taskgroup in job.taskgroups.all %}
& \multicolumn{4}{r}{\parbox[b]{8.5cm}{ \textbf{ {% trans 'Total' %} {{taskgroup.code}} - {{taskgroup.name|tex_escape}} }} } & \textbf{ {{taskgroup.estimate_total|money}}  } \\*
{% endfor %}
{% endfor %}
