...
{% for job in jobs.all %}
{{job.code|bold}} & \multicolumn{5}{l}{\parbox[t]{15cm}{ {{job.name|tex_escape|bold}} }} \\
{% for taskgroup in job.taskgroups.all %}
{{taskgroup.code|bold}} & \multicolumn{5}{l}{\parbox[t]{15cm}{ {{taskgroup.name|tex_escape|bold}} }} \\

{% for task in taskgroup.tasks.all %}
{% for instance in task.taskinstances.all %}
{{instance.code}}
    & \multicolumn{5}{l}{\parbox[t]{9cm}{ {{instance.full_name|tex_escape}} }} \\*
    & \multicolumn{5}{l}{\parbox[t]{9cm}{ {{instance.full_description|tex_escape}} }} \\*
