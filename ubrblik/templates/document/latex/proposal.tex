...
\tabucline{2-6}
& \multicolumn{4}{r} {\textbf{Total without VAT}} & \textbf{ {{jobs.estimate_total|floatformat:2}} \euro\ } \\*
& \multicolumn{4}{r} {\textbf{19,00\% VAT}} & \textbf{ {{jobs.estimate_tax_total|floatformat:2}} \euro\ } \\*
& \multicolumn{4}{r} {\textbf{Total including VAT}} & \textbf{ {{jobs.estimate_gross_total|floatformat:2}} \euro\ } \\*
