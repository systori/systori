...
\tabucline{2-6}
& \multicolumn{4}{r}{\bfseries{ {% trans 'Total without VAT' %} }} & \bfseries{ {{jobs.billable_total|money|tex_escape|trim}}  } \\*
& \multicolumn{4}{r}{\bfseries{ 19,00\% {% trans 'VAT' %} }} & \bfseries{ {{jobs.billable_tax_total|money|tex_escape|trim}}  } \\*
& \multicolumn{4}{r}{\bfseries{ {% trans 'Total including VAT' %} }} & \bfseries{ {{jobs.billable_gross_total|money|tex_escape|trim}}  } \\*
